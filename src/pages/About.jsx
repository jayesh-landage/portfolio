  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Jayesh Landage</strong> — an aspiring{" "}
          <strong>Computer Engineer</strong> and{" "}
          <strong>Web Developer (Full Stack) enthusiast</strong> who loves turning ideas
          into digital systems. I’m deeply fascinated by how data and
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>KKWIEER (SPPU University)</strong> — Nashik,
                  Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  2th Year (Pursuing) | GPA: 9.25
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>2025 – 2028</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>S.V.V.M. School</strong> — Wada,
                  Palghar,Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Maharashtra Board | Percentage: 88.50%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>G.D.K. Gurukul School</strong> — Thane,
                  Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Maharashtra Board | Percentage: 89.80%
                </p>
