...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Lost in the beauty of the Nature 🌲🌫️",
      photos: ["/gallery/self2.jpeg", "/gallery/self.jpg"],
    },
    {
      id: 2,
      caption:
        "Weekend getaway to clear my head 🌄 Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/self4.jpeg", "/gallery/self3.jpg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Simplifying hostel operations with technology — from student registration to room allocation, all in one platform. 🏠💻",
      photos: ["/gallery/h1.png", "/gallery/h2.png"],
    },
    
    {
      id: 2,
      caption:
        "Driving smarter mobility for large-scale events through intelligent traffic and parking management. 🚗🅿️",
      photos: ["/gallery/k1.png", "/gallery/k2.png","/gallery/k3.png", "/gallery/k4.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Proud to be selected as a Core Member of the Young Indians Learning Vertical. 🌟 Ready to learn, lead, and create meaningful impact. The journey begins! 🚀📚 ",
      photos: ["/gallery/ach1.png"],
    },
    {
      id: 1,
      caption: "Proud to be selected as a Core Member of the Young Indians Learning Vertical. 🌟 Ready to learn, lead, and create meaningful impact. The journey begins! 🚀📚 #",
